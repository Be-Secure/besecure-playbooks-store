...
function __besman_init() {
    ...
    local var_array=("BESMAN_TARGET_REPO_TYPE" "BESMAN_TARGET_REPO_URL" "BESMAN_TARGET_BRANCH_NAME" "BESMAN_TARGET_DEPTH_VAL" "BESMAN_ARTIFACT_NAME" "BESMAN_ASSESSMENT_DATASTORE_DIR" "BESMAN_WATCHTOWER_PATH")
