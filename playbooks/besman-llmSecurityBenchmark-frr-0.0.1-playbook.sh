...
function __besman_init() {
    ...
    export ASSESSMENT_TOOL_NAME="CyberSecEval"
    export ASSESSMENT_TOOL_TYPE="LLMSecurityBenchmark"
    export ASSESSMENT_TOOL_VERSION="3"
    #export BESLAB_OWNER_TYPE="Organization"
    #export BESLAB_OWNER_NAME="Be-Secure"
    export ASSESSMENT_TOOL_PLAYBOOK="besman-llmSecurityBenchmark-frr-0.0.1-playbook.sh"

    local steps_file_name="besman-llmSecurityBenchmark-frr-0.0.1-steps.sh"
    ...
    if [[ $flag == true ]]; then
        ...
        export DETAILED_REPORT_PATH="$FRR_TEST_REPORT_PATH"
