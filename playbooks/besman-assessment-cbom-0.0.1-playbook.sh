...
function __besman_init() {
    ...
    if [[ $flag == true ]]; then
        ...
        export CBOM_PATH="$BESMAN_ASSESSMENT_DATASTORE_DIR/$BESMAN_ARTIFACT_NAME/$BESMAN_ARTIFACT_VERSION/cbom"
        export DETAILED_REPORT_PATH="$CBOM_PATH/$BESMAN_ARTIFACT_NAME-$BESMAN_ARTIFACT_VERSION-cbom-report.json"
        mkdir -p "$CBOM_PATH"
