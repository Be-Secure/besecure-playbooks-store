...
function __besman_init() {
    ...
    export ASSESSMENT_TOOL_NAME="BERT_AUTHOR_Sentiment_analysis"
    export ASSESSMENT_TOOL_TYPE="nlp"
    export ASSESSMENT_TOOL_VERSION="1.0.0"
    export ASSESSMENT_TOOL_PLAYBOOK="besman-$ASSESSMENT_TOOL_NAME-0.0.1-steps.sh"

    local steps_file_name="besman-$ASSESSMENT_TOOL_NAME.ipynb"
