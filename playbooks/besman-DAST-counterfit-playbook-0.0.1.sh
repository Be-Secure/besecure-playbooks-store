...
function __besman_init() {
    ...
    export ASSESSMENT_TOOL_NAME="DAST-counterfit"
    ...
    export ASSESSMENT_TOOL_PLAYBOOK="besman-$ASSESSMENT_TOOL_NAME-playbook-$ASSESSMENT_PLAYBOOK_VERSION.sh"
    ...
    local steps_file_name="besman-$ASSESSMENT_TOOL_NAME-steps-$ASSESSMENT_PLAYBOOK_VERSION.ipynb"
